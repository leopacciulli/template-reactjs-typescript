...
<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/leopacciulli/template-reactjs-typescript?color=yellow">

  <img alt="GitHub top language" src="https://img.shields.io/github/languages/top/leopacciulli/template-reactjs-typescript?color=yellow">

  <img alt="GitHub repo size in bytes" src="https://img.shields.io/github/repo-size/leopacciulli/template-reactjs-typescript?color=yellow">
...
Clone the project: `git clone https://github.com/leopacciulli/template-reactjs-typescript.git`

🖥 To run the **Front-End**, open terminal and execute the following commands:

````zsh
# to enter in project folder
